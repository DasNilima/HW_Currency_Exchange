...
# add magic methods here
    ...
    def __sub__(self, other):
        # Defines the '-' operator.
        # If other is a Currency object the currency values are subtracted and the result will be the unit of
        # self. If other is an int or a float, other will be treated as a USD value.
        if type(other) == int or type(other) == float:
            x = (other * Currency.currencies[self.unit])
        else:
            x = (
